...
<template>
  ...
  <v-container id="bikes-container" class="bg-surface-variant mb-6">
    <div class="mb-10" v-for="bike in bikes" :key="bike.id">
      <v-row>
        <v-col cols="4">
          <v-row>
            <v-img
        ...
        <v-col cols="8">
          ...
          <v-row class="ml-10">
            ...
            <v-col cols="2">
              <v-btn variant="outlined" class="mb-2 button-border" color="blue" :disabled="!bike.state.available">
                <h3><b>rent</b></h3>
              </v-btn> <br>
